"""
Django settings for virtualshope project.
"""
...
ROOT_URLCONF = 'virtualshope.urls'
...
WSGI_APPLICATION = 'virtualshope.wsgi.application'
...
TIME_ZONE = config('TIME_ZONE', default='America/Guatemala')
